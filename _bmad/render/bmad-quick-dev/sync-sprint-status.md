...
- `story_key` is unset
- `/Users/nouredinezerrai/projets/bmad-portal0/prjdocs/implementation-artifacts/sprint-status.yaml` does not exist on disk

## Instructions

1. Load the FULL `/Users/nouredinezerrai/projets/bmad-portal0/prjdocs/implementation-artifacts/sprint-status.yaml` file.
